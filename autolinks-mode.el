...
(setq org-autolinks-mode-dir "~/Dropbox/Org/")

;; Get all .org files in this directory. 
(setq org-autolinks-mode-files (directory-files org-autolinks-mode-dir t "[.]org\\'"))

;; Convert it to a list of just the filenames, without paths.
(setq org-autolinks-mode-files-bare
      (mapcar 'file-name-nondirectory org-autolinks-mode-files))

;; Strip extensions
(setq org-autolinks-mode-topics
      (mapcar 'file-name-sans-extension org-autolinks-mode-files-bare))

(describe-variable org-autolinks-mode-topics)
...
(define-minor-mode org-autolinks-mode
  ...
  :keymap (let ((map (make-sparse-keymap)))
            (define-key map (kbd "C-c f") 'org-autolinks-mode-open-link)
            map))
